...
class Lukio_Email_Confirmation extends \ElementorPro\Modules\Forms\Actions\Email
{
    ...
    public function register_settings_section($widget)
    {
        ...
        $widget->add_control(
            'lukio_email_confirmation_email_sender_name',
            [
                'label' => esc_html__('Email Sender Name', 'lukio-elementor-form-confirmation-with-pdf'),
                'type' => \Elementor\Controls_Manager::TEXT,
            ]
        );

        $widget->add_control(
            'lukio_email_confirmation_email_sender_email',
            [
                'label' => esc_html__('Email Sender Email', 'lukio-elementor-form-confirmation-with-pdf'),
                'type' => \Elementor\Controls_Manager::TEXT,
            ]
        );
    ...
    public function run($record, $ajax_handler)
    {
        ...
        $headers[] = 'From: '.$settings['lukio_email_confirmation_email_sender_name'] .' <'.$settings['lukio_email_confirmation_email_sender_email'].'>';
    ...
    public function on_export($element)
    {
        unset(
            ...
            $element['lukio_email_confirmation_email_sender_name'],
            $element['lukio_email_confirmation_email_sender_email'],
